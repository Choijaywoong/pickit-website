...
const TRANSLATIONS = {
  ko: {
    ...
    ctaBtn:             '무료로 시작하기 →',
    footerCopy:         '© 2025 PICKIT. All rights reserved.',
    ...
    ob1Desc:            '운영 방식을 파악해 PICKIT을 최적화합니다.',
  ...
  en: {
    ...
    demoEyebrow:        'What PICKIT Does',
    demoTitle:          'Just Chat.\nPICKIT Handles the Rest.',
    ...
    // ── Onboarding ──
    ob1Progress:        'Step 1 / 2',
    ob1Question:        'Do you manage your own inventory?',
    ob1Desc:            'This helps PICKIT optimize your experience.',
